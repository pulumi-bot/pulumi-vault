...
class EntityAlias(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, canonical_id=None, mount_accessor=None, name=None, __props__=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[str] canonical_id: ID of the entity to which this is an alias.
        :param pulumi.Input[str] mount_accessor: Mount accessor to which this alias belongs toMount accessor to which this alias belongs to.
        :param pulumi.Input[str] name: Name of the entity alias.
        """
