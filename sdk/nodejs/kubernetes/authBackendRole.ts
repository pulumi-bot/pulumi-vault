...
export class AuthBackendRole extends pulumi.CustomResource {
    ...
    /**
     * List of service account names able to access this role. If set to `["*"]` all names are allowed, both this and
     * bound_service_account_namespaces can not be "*".
     */
    public readonly boundServiceAccountNames!: pulumi.Output<string[]>;
    /**
     * List of namespaces allowed to access this role. If set to `["*"]` all namespaces are allowed, both this and
