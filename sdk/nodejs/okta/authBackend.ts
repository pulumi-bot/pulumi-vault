...
export class AuthBackend extends pulumi.CustomResource {
    ...
    /**
     * When true, requests by Okta for a MFA check will be bypassed. This also disallows certain status checks on the
     * account, such as whether the password is expired.
     */
