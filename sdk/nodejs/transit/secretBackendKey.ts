...
export class SecretBackendKey extends pulumi.CustomResource {
    ...
    /**
     * Specifies if key derivation is to be used. If enabled, all encrypt/decrypt requests to this key must provide a
    ...
    /**
     * Specifies the type of key to create. The currently-supported types are: aes256-gcm96, chacha20-poly1305, ed25519,
     * ecdsa-p256, rsa-2048, rsa-4096
     */
