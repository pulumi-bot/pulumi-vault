...
type GetPolicyDocumentRuleAllowedParameterArgsInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleAllowedParameterArgsOutput() GetPolicyDocumentRuleAllowedParameterArgsOutput
	ToGetPolicyDocumentRuleAllowedParameterArgsOutputWithContext(context.Context) GetPolicyDocumentRuleAllowedParameterArgsOutput
}

type GetPolicyDocumentRuleAllowedParameterArgsArgs struct {
	// name of permitted or denied parameter.
	Key pulumi.StringInput `pulumi:"key"`
	// list of values what are permitted or denied by policy rule.
	Values pulumi.StringArrayInput `pulumi:"values"`
...
func (GetPolicyDocumentRuleAllowedParameterArgsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleAllowedParameterArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleAllowedParameterArgsArgs) ToGetPolicyDocumentRuleAllowedParameterArgsOutput() GetPolicyDocumentRuleAllowedParameterArgsOutput {
	return i.ToGetPolicyDocumentRuleAllowedParameterArgsOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleAllowedParameterArgsArgs) ToGetPolicyDocumentRuleAllowedParameterArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleAllowedParameterArgsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleAllowedParameterArgsOutput)
}

type GetPolicyDocumentRuleAllowedParameterArgsArrayInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutput() GetPolicyDocumentRuleAllowedParameterArgsArrayOutput
	ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutputWithContext(context.Context) GetPolicyDocumentRuleAllowedParameterArgsArrayOutput
}

type GetPolicyDocumentRuleAllowedParameterArgsArray []GetPolicyDocumentRuleAllowedParameterArgsInput

func (GetPolicyDocumentRuleAllowedParameterArgsArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleAllowedParameterArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleAllowedParameterArgsArray) ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutput() GetPolicyDocumentRuleAllowedParameterArgsArrayOutput {
	return i.ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleAllowedParameterArgsArray) ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleAllowedParameterArgsArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleAllowedParameterArgsArrayOutput)
}

type GetPolicyDocumentRuleAllowedParameterArgsOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleAllowedParameterArgsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleAllowedParameterArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleAllowedParameterArgsOutput) ToGetPolicyDocumentRuleAllowedParameterArgsOutput() GetPolicyDocumentRuleAllowedParameterArgsOutput {
	return o
}

func (o GetPolicyDocumentRuleAllowedParameterArgsOutput) ToGetPolicyDocumentRuleAllowedParameterArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleAllowedParameterArgsOutput {
	return o
}

// name of permitted or denied parameter.
func (o GetPolicyDocumentRuleAllowedParameterArgsOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleAllowedParameterArgs) string { return v.Key }).(pulumi.StringOutput)
}

// list of values what are permitted or denied by policy rule.
func (o GetPolicyDocumentRuleAllowedParameterArgsOutput) Values() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleAllowedParameterArgs) []string { return v.Values }).(pulumi.StringArrayOutput)
}

type GetPolicyDocumentRuleAllowedParameterArgsArrayOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleAllowedParameterArgsArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleAllowedParameterArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleAllowedParameterArgsArrayOutput) ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutput() GetPolicyDocumentRuleAllowedParameterArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleAllowedParameterArgsArrayOutput) ToGetPolicyDocumentRuleAllowedParameterArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleAllowedParameterArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleAllowedParameterArgsArrayOutput) Index(i pulumi.IntInput) GetPolicyDocumentRuleAllowedParameterArgsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetPolicyDocumentRuleAllowedParameterArgs {
		return vs[0].([]GetPolicyDocumentRuleAllowedParameterArgs)[vs[1].(int)]
	}).(GetPolicyDocumentRuleAllowedParameterArgsOutput)
}

type GetPolicyDocumentRuleArgs struct {
	// Whitelists a list of keys and values that are permitted on the given path. See Parameters below.
	AllowedParameters []GetPolicyDocumentRuleAllowedParameterArgs `pulumi:"allowedParameters"`
	// A list of capabilities that this rule apply to `path`. For example, ["read", "write"].
	Capabilities []string `pulumi:"capabilities"`
	// Blacklists a list of parameter and values. Any values specified here take precedence over `allowedParameter`. See Parameters below.
	DeniedParameters []GetPolicyDocumentRuleDeniedParameterArgs `pulumi:"deniedParameters"`
	// Description of the rule. Will be added as a commend to rendered rule.
	Description *string `pulumi:"description"`
	// The maximum allowed TTL that clients can specify for a wrapped response.
	MaxWrappingTtl *string `pulumi:"maxWrappingTtl"`
...
type GetPolicyDocumentRuleArgsInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleArgsOutput() GetPolicyDocumentRuleArgsOutput
	ToGetPolicyDocumentRuleArgsOutputWithContext(context.Context) GetPolicyDocumentRuleArgsOutput
}

type GetPolicyDocumentRuleArgsArgs struct {
	// Whitelists a list of keys and values that are permitted on the given path. See Parameters below.
	AllowedParameters GetPolicyDocumentRuleAllowedParameterArgsArrayInput `pulumi:"allowedParameters"`
	// A list of capabilities that this rule apply to `path`. For example, ["read", "write"].
	Capabilities pulumi.StringArrayInput `pulumi:"capabilities"`
	// Blacklists a list of parameter and values. Any values specified here take precedence over `allowedParameter`. See Parameters below.
	DeniedParameters GetPolicyDocumentRuleDeniedParameterArgsArrayInput `pulumi:"deniedParameters"`
	// Description of the rule. Will be added as a commend to rendered rule.
	Description pulumi.StringPtrInput `pulumi:"description"`
	// The maximum allowed TTL that clients can specify for a wrapped response.
	MaxWrappingTtl pulumi.StringPtrInput `pulumi:"maxWrappingTtl"`
...
func (GetPolicyDocumentRuleArgsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleArgsArgs) ToGetPolicyDocumentRuleArgsOutput() GetPolicyDocumentRuleArgsOutput {
	return i.ToGetPolicyDocumentRuleArgsOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleArgsArgs) ToGetPolicyDocumentRuleArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleArgsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleArgsOutput)
}

type GetPolicyDocumentRuleArgsArrayInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleArgsArrayOutput() GetPolicyDocumentRuleArgsArrayOutput
	ToGetPolicyDocumentRuleArgsArrayOutputWithContext(context.Context) GetPolicyDocumentRuleArgsArrayOutput
}

type GetPolicyDocumentRuleArgsArray []GetPolicyDocumentRuleArgsInput

func (GetPolicyDocumentRuleArgsArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleArgsArray) ToGetPolicyDocumentRuleArgsArrayOutput() GetPolicyDocumentRuleArgsArrayOutput {
	return i.ToGetPolicyDocumentRuleArgsArrayOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleArgsArray) ToGetPolicyDocumentRuleArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleArgsArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleArgsArrayOutput)
}

type GetPolicyDocumentRuleArgsOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleArgsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleArgsOutput) ToGetPolicyDocumentRuleArgsOutput() GetPolicyDocumentRuleArgsOutput {
	return o
}

func (o GetPolicyDocumentRuleArgsOutput) ToGetPolicyDocumentRuleArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleArgsOutput {
	return o
}

// Whitelists a list of keys and values that are permitted on the given path. See Parameters below.
func (o GetPolicyDocumentRuleArgsOutput) AllowedParameters() GetPolicyDocumentRuleAllowedParameterArgsArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) []GetPolicyDocumentRuleAllowedParameterArgs {
		return v.AllowedParameters
	}).(GetPolicyDocumentRuleAllowedParameterArgsArrayOutput)
}

// A list of capabilities that this rule apply to `path`. For example, ["read", "write"].
func (o GetPolicyDocumentRuleArgsOutput) Capabilities() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) []string { return v.Capabilities }).(pulumi.StringArrayOutput)
}

// Blacklists a list of parameter and values. Any values specified here take precedence over `allowedParameter`. See Parameters below.
func (o GetPolicyDocumentRuleArgsOutput) DeniedParameters() GetPolicyDocumentRuleDeniedParameterArgsArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) []GetPolicyDocumentRuleDeniedParameterArgs {
		return v.DeniedParameters
	}).(GetPolicyDocumentRuleDeniedParameterArgsArrayOutput)
}

// Description of the rule. Will be added as a commend to rendered rule.
func (o GetPolicyDocumentRuleArgsOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// The maximum allowed TTL that clients can specify for a wrapped response.
func (o GetPolicyDocumentRuleArgsOutput) MaxWrappingTtl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) *string { return v.MaxWrappingTtl }).(pulumi.StringPtrOutput)
}

// The minimum allowed TTL that clients can specify for a wrapped response.
func (o GetPolicyDocumentRuleArgsOutput) MinWrappingTtl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) *string { return v.MinWrappingTtl }).(pulumi.StringPtrOutput)
}

// A path in Vault that this rule applies to.
func (o GetPolicyDocumentRuleArgsOutput) Path() pulumi.StringOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) string { return v.Path }).(pulumi.StringOutput)
}

// A list of parameters that must be specified.
func (o GetPolicyDocumentRuleArgsOutput) RequiredParameters() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleArgs) []string { return v.RequiredParameters }).(pulumi.StringArrayOutput)
}

type GetPolicyDocumentRuleArgsArrayOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleArgsArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleArgsArrayOutput) ToGetPolicyDocumentRuleArgsArrayOutput() GetPolicyDocumentRuleArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleArgsArrayOutput) ToGetPolicyDocumentRuleArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleArgsArrayOutput) Index(i pulumi.IntInput) GetPolicyDocumentRuleArgsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetPolicyDocumentRuleArgs {
		return vs[0].([]GetPolicyDocumentRuleArgs)[vs[1].(int)]
	}).(GetPolicyDocumentRuleArgsOutput)
}
...
type GetPolicyDocumentRuleDeniedParameterArgsInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleDeniedParameterArgsOutput() GetPolicyDocumentRuleDeniedParameterArgsOutput
	ToGetPolicyDocumentRuleDeniedParameterArgsOutputWithContext(context.Context) GetPolicyDocumentRuleDeniedParameterArgsOutput
}

type GetPolicyDocumentRuleDeniedParameterArgsArgs struct {
	// name of permitted or denied parameter.
	Key pulumi.StringInput `pulumi:"key"`
	// list of values what are permitted or denied by policy rule.
	Values pulumi.StringArrayInput `pulumi:"values"`
...
func (GetPolicyDocumentRuleDeniedParameterArgsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleDeniedParameterArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleDeniedParameterArgsArgs) ToGetPolicyDocumentRuleDeniedParameterArgsOutput() GetPolicyDocumentRuleDeniedParameterArgsOutput {
	return i.ToGetPolicyDocumentRuleDeniedParameterArgsOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleDeniedParameterArgsArgs) ToGetPolicyDocumentRuleDeniedParameterArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleDeniedParameterArgsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleDeniedParameterArgsOutput)
}

type GetPolicyDocumentRuleDeniedParameterArgsArrayInput interface {
	pulumi.Input

	ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutput() GetPolicyDocumentRuleDeniedParameterArgsArrayOutput
	ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutputWithContext(context.Context) GetPolicyDocumentRuleDeniedParameterArgsArrayOutput
}

type GetPolicyDocumentRuleDeniedParameterArgsArray []GetPolicyDocumentRuleDeniedParameterArgsInput

func (GetPolicyDocumentRuleDeniedParameterArgsArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleDeniedParameterArgs)(nil)).Elem()
}

func (i GetPolicyDocumentRuleDeniedParameterArgsArray) ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutput() GetPolicyDocumentRuleDeniedParameterArgsArrayOutput {
	return i.ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutputWithContext(context.Background())
}

func (i GetPolicyDocumentRuleDeniedParameterArgsArray) ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleDeniedParameterArgsArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetPolicyDocumentRuleDeniedParameterArgsArrayOutput)
}

type GetPolicyDocumentRuleDeniedParameterArgsOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleDeniedParameterArgsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPolicyDocumentRuleDeniedParameterArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleDeniedParameterArgsOutput) ToGetPolicyDocumentRuleDeniedParameterArgsOutput() GetPolicyDocumentRuleDeniedParameterArgsOutput {
	return o
}

func (o GetPolicyDocumentRuleDeniedParameterArgsOutput) ToGetPolicyDocumentRuleDeniedParameterArgsOutputWithContext(ctx context.Context) GetPolicyDocumentRuleDeniedParameterArgsOutput {
	return o
}

// name of permitted or denied parameter.
func (o GetPolicyDocumentRuleDeniedParameterArgsOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleDeniedParameterArgs) string { return v.Key }).(pulumi.StringOutput)
}

// list of values what are permitted or denied by policy rule.
func (o GetPolicyDocumentRuleDeniedParameterArgsOutput) Values() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetPolicyDocumentRuleDeniedParameterArgs) []string { return v.Values }).(pulumi.StringArrayOutput)
}

type GetPolicyDocumentRuleDeniedParameterArgsArrayOutput struct{ *pulumi.OutputState }

func (GetPolicyDocumentRuleDeniedParameterArgsArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetPolicyDocumentRuleDeniedParameterArgs)(nil)).Elem()
}

func (o GetPolicyDocumentRuleDeniedParameterArgsArrayOutput) ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutput() GetPolicyDocumentRuleDeniedParameterArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleDeniedParameterArgsArrayOutput) ToGetPolicyDocumentRuleDeniedParameterArgsArrayOutputWithContext(ctx context.Context) GetPolicyDocumentRuleDeniedParameterArgsArrayOutput {
	return o
}

func (o GetPolicyDocumentRuleDeniedParameterArgsArrayOutput) Index(i pulumi.IntInput) GetPolicyDocumentRuleDeniedParameterArgsOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetPolicyDocumentRuleDeniedParameterArgs {
		return vs[0].([]GetPolicyDocumentRuleDeniedParameterArgs)[vs[1].(int)]
	}).(GetPolicyDocumentRuleDeniedParameterArgsOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(GetPolicyDocumentRuleAllowedParameterArgsOutput{})
	pulumi.RegisterOutputType(GetPolicyDocumentRuleAllowedParameterArgsArrayOutput{})
	pulumi.RegisterOutputType(GetPolicyDocumentRuleArgsOutput{})
	pulumi.RegisterOutputType(GetPolicyDocumentRuleArgsArrayOutput{})
	...
	pulumi.RegisterOutputType(GetPolicyDocumentRuleDeniedParameterArgsOutput{})
	pulumi.RegisterOutputType(GetPolicyDocumentRuleDeniedParameterArgsArrayOutput{})
