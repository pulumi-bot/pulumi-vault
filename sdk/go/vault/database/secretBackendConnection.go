...
type secretBackendConnectionArgs struct {
	...
	Backend string `pulumi:"backend"`
	// A nested block containing configuration options for Cassandra connections.
	Cassandra *SecretBackendConnectionCassandraArgs `pulumi:"cassandra"`
	// A map of sensitive data to pass to the endpoint. Useful for templated connection strings.
	Data map[string]interface{} `pulumi:"data"`
	// A nested block containing configuration options for Elasticsearch connections.
	Elasticsearch *SecretBackendConnectionElasticsearchArgs `pulumi:"elasticsearch"`
	// A nested block containing configuration options for SAP HanaDB connections.
	Hana *SecretBackendConnectionHanaArgs `pulumi:"hana"`
	// A nested block containing configuration options for MongoDB connections.
	Mongodb *SecretBackendConnectionMongodbArgs `pulumi:"mongodb"`
	// A nested block containing configuration options for MSSQL connections.
	Mssql *SecretBackendConnectionMssqlArgs `pulumi:"mssql"`
	// A nested block containing configuration options for MySQL connections.
	Mysql *SecretBackendConnectionMysqlArgs `pulumi:"mysql"`
	// A nested block containing configuration options for Aurora MySQL connections.
	MysqlAurora *SecretBackendConnectionMysqlAuroraArgs `pulumi:"mysqlAurora"`
	// A nested block containing configuration options for legacy MySQL connections.
	MysqlLegacy *SecretBackendConnectionMysqlLegacyArgs `pulumi:"mysqlLegacy"`
	// A nested block containing configuration options for RDS MySQL connections.
	MysqlRds *SecretBackendConnectionMysqlRdsArgs `pulumi:"mysqlRds"`
	// A unique name to give the database connection.
	Name *string `pulumi:"name"`
	// A nested block containing configuration options for Oracle connections.
	Oracle *SecretBackendConnectionOracleArgs `pulumi:"oracle"`
	// A nested block containing configuration options for PostgreSQL connections.
	Postgresql *SecretBackendConnectionPostgresqlArgs `pulumi:"postgresql"`
	// A list of database statements to be executed to rotate the root user's credentials.
	RootRotationStatements []string `pulumi:"rootRotationStatements"`
	// Whether the connection should be verified on
	// initial configuration or not.
...
type SecretBackendConnectionArgs struct {
	...
	// A nested block containing configuration options for Cassandra connections.
	Cassandra SecretBackendConnectionCassandraArgsPtrInput
	// A map of sensitive data to pass to the endpoint. Useful for templated connection strings.
	Data pulumi.MapInput
	// A nested block containing configuration options for Elasticsearch connections.
	Elasticsearch SecretBackendConnectionElasticsearchArgsPtrInput
	// A nested block containing configuration options for SAP HanaDB connections.
	Hana SecretBackendConnectionHanaArgsPtrInput
	// A nested block containing configuration options for MongoDB connections.
	Mongodb SecretBackendConnectionMongodbArgsPtrInput
	// A nested block containing configuration options for MSSQL connections.
	Mssql SecretBackendConnectionMssqlArgsPtrInput
	// A nested block containing configuration options for MySQL connections.
	Mysql SecretBackendConnectionMysqlArgsPtrInput
	// A nested block containing configuration options for Aurora MySQL connections.
	MysqlAurora SecretBackendConnectionMysqlAuroraArgsPtrInput
	// A nested block containing configuration options for legacy MySQL connections.
	MysqlLegacy SecretBackendConnectionMysqlLegacyArgsPtrInput
	// A nested block containing configuration options for RDS MySQL connections.
	MysqlRds SecretBackendConnectionMysqlRdsArgsPtrInput
	// A unique name to give the database connection.
	Name pulumi.StringPtrInput
	// A nested block containing configuration options for Oracle connections.
	Oracle SecretBackendConnectionOracleArgsPtrInput
	// A nested block containing configuration options for PostgreSQL connections.
	Postgresql SecretBackendConnectionPostgresqlArgsPtrInput
	// A list of database statements to be executed to rotate the root user's credentials.
	RootRotationStatements pulumi.StringArrayInput
	// Whether the connection should be verified on
	// initial configuration or not.
