...
type authBackendArgs struct {
	...
	// Associate Okta groups with policies within Vault.
	// See below for more details.
	Groups []AuthBackendGroupArgsType `pulumi:"groups"`
	// Maximum duration after which authentication will be expired
	// [See the documentation for info on valid duration formats](https://golang.org/pkg/time/#ParseDuration).
	MaxTtl *string `pulumi:"maxTtl"`
	// The Okta organization. This will be the first part of the url `https://XXX.okta.com`
	...
	// Associate Okta users with groups or policies within Vault.
	// See below for more details.
	Users []AuthBackendUserArgsType `pulumi:"users"`
}
...
type AuthBackendArgs struct {
	...
	// Associate Okta groups with policies within Vault.
	// See below for more details.
	Groups AuthBackendGroupArgsTypeArrayInput
	// Maximum duration after which authentication will be expired
	// [See the documentation for info on valid duration formats](https://golang.org/pkg/time/#ParseDuration).
	MaxTtl pulumi.StringPtrInput
	// The Okta organization. This will be the first part of the url `https://XXX.okta.com`
	...
	// Associate Okta users with groups or policies within Vault.
	// See below for more details.
	Users AuthBackendUserArgsTypeArrayInput
}
